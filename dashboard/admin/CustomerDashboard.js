// pages/admin/customers.js or components/CustomerDashboard.js
...
import {
  ...
  searchCustomers
} from '../../lib/firebaseServices'; // Adjusted path for Next.js structure
...
const CustomerDashboard = () => {
  ...
  // Authentication state - only access on client side
  ...
  useEffect(() => {
    ...
    // Get auth state from localStorage only on client side
  ...
  // Load customers when component mounts (client-side only)
  useEffect(() => {
    if (isClient) {
      loadCustomers();
    }
  ...
  const loadCustomers = async () => {
    try {
      ...
      if (typeof window !== 'undefined' && window.gtag) {
        window.gtag('event', 'customer_dashboard_load', {
          event_category: 'Admin',
          event_label: 'Customers Loaded',
    ...
    if (typeof window !== 'undefined') {
      ...
      if (window.gtag) {
        window.gtag('event', 'logout', {
          ...
          event_label: 'Admin Dashboard Logout'
        });
      }
    }
    router.push('/login');
  ...
  const handleStatusUpdate = async (customerId, newStatus) => {
    try {
      ...
      if (result.success) {
        ...
        // Analytics tracking
        if (typeof window !== 'undefined' && window.gtag) {
          window.gtag('event', 'status_update', {
            event_category: 'Customer Management',
            event_label: `${customerId} to ${newStatus}`,
            value: 1
          });
        }
      } else {
  ...
  if (!isClient) {
    return (
      <>
        <Head>
          <title>Loading... | Customer Dashboard</title>
  ...
  if (isLoading && customers.length === 0) {
    return (
      <>
        <Head>
          <title>Loading Customers... | Customer Dashboard</title>
          <meta name="robots" content="noindex, nofollow" />
        </Head>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
  ...
  if (error && customers.length === 0) {
    return (
      <>
        <Head>
          <title>Connection Error | Customer Dashboard</title>
          <meta name="robots" content="noindex, nofollow" />
        </Head>
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
  ...
  return (
    <>
      <Head>
        <title>Customer Management | Nevloh Limited Admin Dashboard</title>
        <meta name="description" content="Manage fuel delivery customers and leads from Firebase database" />
        <meta name="robots" content="noindex, nofollow" />
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <div className="flex items-center mb-2">
                  <button
                    ...
                    className="mr-3 p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 transition-colors"
                    title="Go Back"
                  >
                    <ArrowLeft size={20} />
                  </button>
                ...
                <div className="flex items-center space-x-4 mt-2 text-sm text-gray-500">
                  <span>
                    Logged in as: <strong className="text-gray-700">{authState.userEmail || 'Admin User'}</strong>
                  </span>
                  <span>
                    Role: <strong className="text-blue-600 capitalize">{authState.userRole || 'Unknown'}</strong>
                  </span>
                  {authState.loginTime && (
                    <span>
                      Session: <strong>{new Date(authState.loginTime).toLocaleString()}</strong>
                    </span>
                  )}
                </div>
              </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors flex items-center focus:outline-none focus:ring-2 focus:ring-gray-500"
                  title="Go to Website"
                >
                ...
                <button
                  ...
                  className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  title="Refresh Data"
                >
                ...
                <button
                  onClick={exportToCSV}
                  className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors flex items-center focus:outline-none focus:ring-2 focus:ring-green-500"
                  title="Export to CSV"
                >
                ...
                <button
                  ...
                  className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors flex items-center focus:outline-none focus:ring-2 focus:ring-red-500"
                  title="Logout"
                >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <div className="flex items-center space-x-2">
                            <button
                              ...
                              className="text-blue-600 hover:text-blue-900 p-1 rounded hover:bg-blue-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                              title="View Details"
                            >
                              <Eye size={16} />
                            </button>
                            <a
                              ...
                              className="text-green-600 hover:text-green-900 p-1 rounded hover:bg-green-50 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500"
                              title="Send Email"
                            >
                              <Mail size={16} />
                            </a>
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                      ...
                      className="text-gray-400 hover:text-gray-600 text-2xl p-2 rounded hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500"
                    >
                      ✕
                    </button>
                  </div>
